...
const strengthColor = (score) => {
  switch (score) {
    ...
    case 4:
      return 'bg-mountain-green-light';
    case 5:
    default:
      return 'bg-mountain-green';
  }
};
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 px-4 py-8">
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-100/80 dark:border-gray-700/60">
        ...
        <div className="relative hidden md:block" aria-hidden="true">
          <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${houseImg})` }} />
          ...
          <div className="relative h-full w-full p-8 flex flex-col justify-between text-white">
            ...
            <div>
              <h2 className="text-3xl font-semibold leading-snug">Create your account</h2>
              <p className="mt-2 text-sm text-white/90 max-w-sm">
                Join to unlock personalized dashboards, saved searches, and verified property insights.
              </p>
            </div>
            <p className="text-xs text-white/80">Fast signup • Secure • Dark mode ready</p>
          </div>
        </div>
        ...
        <div className="p-6 sm:p-8 md:p-10">
          <div className="mx-auto w-full max-w-md">
            <div className="flex items-center gap-3 mb-6 md:mb-8">
              ...
              <span className="text-lg font-semibold text-gray-900 dark:text-white">Create your account</span>
            </div>

            {/* OAuth (mock) */}
            <div className="space-y-3">
              <button type="button" className="w-full inline-flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-300 dark:border-gray-700 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">or create with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div id="password-help" className="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-2">
                  <div className="flex-1 h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                    <div className={`h-full transition-all duration-300 ${strengthColor(score)}`} style={{ width: `${(score/5)*100}%` }} />
                  </div>
                  <span>{['Very weak','Weak','Fair','Good','Strong'][Math.max(0, score-1)] || 'Very weak'}</span>
                </div>
              </div>
              ...
              <p className="text-sm text-center text-gray-600 dark:text-gray-400">
                ...
                <Link to="/login" className="font-medium text-mountain-green hover:text-mountain-green-light">Sign in</Link>
              </p>
            </form>
          </div>
        </div>
